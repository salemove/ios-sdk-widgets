...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "GliaCoreSDK",
            url: "https://github.com/salemove/ios-bundle/releases/download/1.3.7/GliaCoreSDK.xcframework.zip",
            checksum: "a7c12528814b412847050b1d71eedfabc497a3570d481720af656b3c1e9aac4a"
        ),
        .target(
            name: "GliaWidgets",
            dependencies: [

...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "GliaCoreSDK",
            url: "https://github.com/salemove/ios-bundle/releases/download/2.6.10/GliaCoreSDK.xcframework.zip",
            checksum: "2b3ca7f1111f46610fccf27c8ddddc2c4012665885e8208471226e55d32828be"
        ),
        .binaryTarget(
            name: "GliaWidgetsSDKXcf",
            url: "https://github.com/salemove/ios-sdk-widgets/releases/download/3.5.5/GliaWidgetsXcf.xcframework.zip",
            checksum: "ac4375d761a9088c3d51e78550da8f56bf13e171fc4874035673f0b0f6a85dcf"
        ),
        .binaryTarget(

...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "GliaCoreSDK",
            url: "https://github.com/salemove/ios-bundle/releases/download/2.6.8/GliaCoreSDK.xcframework.zip",
            checksum: "69aa4efd268854fab56881261c38f14af397dead86bc381a69b2d4f120ee0dc0"
        ),
        .binaryTarget(
            name: "GliaWidgetsSDKXcf",
            url: "https://github.com/salemove/ios-sdk-widgets/releases/download/3.5.3/GliaWidgetsXcf.xcframework.zip",
            checksum: "508845a8d2320277ccd3c876e65fcb27e4ba04b7896952e7c2da86760a89b08d"
        ),
        .binaryTarget(

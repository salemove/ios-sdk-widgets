...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "GliaCoreSDK",
            url: "https://github.com/salemove/ios-bundle/releases/download/2.6.0/GliaCoreSDK.xcframework.zip",
            checksum: "d76a7e733394ed606382592eb957e4edb11db057fe401979e34c24a8a1c20f2f"
        ),
        .binaryTarget(

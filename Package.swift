...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "GliaCoreSDK",
            url: "https://github.com/salemove/ios-bundle/releases/download/2.1.2/GliaCoreSDK.xcframework.zip",
            checksum: "68cbe6bcb9ff900c06a9071255073718c22f120e7deabe2a9e4a9025f2da3912"
        ),
        .binaryTarget(

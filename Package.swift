...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "GliaCoreSDK",
            url: "https://github.com/salemove/ios-bundle/releases/download/2.1.4/GliaCoreSDK.xcframework.zip",
            checksum: "be8db3c9a415edbcc92d22c5cf276370479c786ef1223b2470f30e7fadff99ab"
        ),
        .binaryTarget(

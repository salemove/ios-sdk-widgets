...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "GliaCoreSDK",
            url: "https://github.com/salemove/ios-bundle/releases/download/1.1.2/GliaCoreSDK.xcframework.zip",
            checksum: "a4b52dd6b930904ee655d3065a1c76eda2546e2e5cad6649826f61843737e31b"
        ),
        .binaryTarget(
            name: "GliaWidgetsXcf",

...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "GliaCoreSDK",
            url: "https://github.com/salemove/ios-bundle/releases/download/2.0.5/GliaCoreSDK.xcframework.zip",
            checksum: "f3bd6d75540e4a4a0493dcebf2bb8be78288b5aa4ab96caa39546d163dd77b3c"
        ),
        .binaryTarget(

...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/salemove/ios-sdk-widgets/releases/download/3.5.4/GliaWidgetsXcf.xcframework.zip",
            checksum: "174db806feb9689b713109223fe708ec061e6ac1b9eb6ae6c12da34ef1fbbd25"
        ),
        .binaryTarget(

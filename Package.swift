...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "GliaCoreSDK",
            url: "https://github.com/salemove/ios-bundle/releases/download/1.5.1/GliaCoreSDK.xcframework.zip",
            checksum: "548be86b5d9dba88a241b4015beb274c336483fc570887e767a06ab1966e09ec"
        ),
        .binaryTarget(
            name: "GliaWidgetsSDKXcf",
            url: "https://github.com/salemove/ios-sdk-widgets/releases/download/2.7.0/GliaWidgetsXcf.xcframework.zip",
            checksum: "55744febe80304cc64a31bbb0112f90ebf6a97184d8804fb76a341bf1699cb0b"
        ),
        .target(
            name: "GliaWidgets",
            dependencies: [

...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/salemove/ios-sdk-widgets/releases/download/3.5.1/GliaWidgetsXcf.xcframework.zip",
            checksum: "128301c1147c310061c9d101daf99a611590e0df8916f1e246d3b2cf666754f8"
        ),
        .binaryTarget(

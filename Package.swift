...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "GliaCoreSDK",
            url: "https://github.com/salemove/ios-bundle/releases/download/2.6.9/GliaCoreSDK.xcframework.zip",
            checksum: "23b3152efa83aa9696f0da58e835f6b6be9ded78358060ee3087857e2605ebca"
        ),
        .binaryTarget(

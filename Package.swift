...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "GliaWidgetsXcf",
            url: "https://github.com/salemove/ios-sdk-widgets/releases/download/0.10.13/GliaWidgetsXcf.xcframework.zip",
            checksum: "c1c3028f6f113570f9ac74c11de003928cd03b4baf38ee164466b87a5ffaff36"
        ),
        .target(
            name: "GliaWidgets",
            path: "GliaWidgets",

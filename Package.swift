...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/salemove/ios-sdk-widgets/releases/download/2.4.4/GliaWidgetsXcf.xcframework.zip",
            checksum: "ce01abebd1ddf90a463ddb420152a2502c22e123935910a587a3a79127e61ee8"
        ),
        .target(
            name: "GliaWidgets",
            dependencies: [

...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "GliaCoreSDK",
            url: "https://github.com/salemove/ios-bundle/releases/download/2.1.0/GliaCoreSDK.xcframework.zip",
            checksum: "274637b89d73c561f02d84e7b9430bc07a758a59aedc1ebf82db482aa8601c75"
        ),
        .binaryTarget(

...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "GliaCoreSDK",
            url: "https://github.com/salemove/ios-bundle/releases/download/2.1.1/GliaCoreSDK.xcframework.zip",
            checksum: "c36218add64dc3b533797413e051cc064e17b6cc6ae2d2ae58f334b5f18db544"
        ),
        .binaryTarget(

...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "GliaCoreSDK",
            url: "https://github.com/salemove/ios-bundle/releases/download/2.2.0/GliaCoreSDK.xcframework.zip",
            checksum: "c96dab481051d23864de394b5f91f7f8793dbe589fbc89cb8a84311f6b159c8c"
        ),
        .binaryTarget(
            name: "GliaWidgetsSDKXcf",
            url: "https://github.com/salemove/ios-sdk-widgets/releases/download/3.2.0/GliaWidgetsXcf.xcframework.zip",
            checksum: "470ca9fd2668e54ef4a73b915abfa84ac03d8b644f36522d289064c915d2511a"
        ),
        .target(
            name: "GliaWidgets",
            dependencies: [

...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "GliaCoreSDK",
            url: "https://github.com/salemove/ios-bundle/releases/download/2.0.11/GliaCoreSDK.xcframework.zip",
            checksum: "739399502d76c71b2321ca7d97db402d93dfe09d9d5cb7117af072e75322f8cb"
        ),
        .binaryTarget(

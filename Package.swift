...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "GliaCoreSDK",
            url: "https://github.com/salemove/ios-bundle/releases/download/2.6.6/GliaCoreSDK.xcframework.zip",
            checksum: "a8c3bdf1323bd3a7013c25ae013dad160fc495fe9203576ed02e700ba3da9591"
        ),
        .binaryTarget(
            name: "GliaWidgetsSDKXcf",
            url: "https://github.com/salemove/ios-sdk-widgets/releases/download/3.5.2/GliaWidgetsXcf.xcframework.zip",
            checksum: "16a3f532b1f724c4a9012858a7ce01d76937054473c1615dc2c1715a65f5bae1"
        ),
        .binaryTarget(

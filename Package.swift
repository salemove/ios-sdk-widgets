...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "GliaCoreSDK",
            url: "https://github.com/salemove/ios-bundle/releases/download/2.0.15/GliaCoreSDK.xcframework.zip",
            checksum: "9e69d7bca35d49efbabd461fdcce9e605c6fc2dbf4003c62d5bee0f2eea1acce"
        ),
        .binaryTarget(

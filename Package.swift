...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "GliaCoreSDK",
            url: "https://github.com/salemove/ios-bundle/releases/download/2.0.12/GliaCoreSDK.xcframework.zip",
            checksum: "ad955312e96929a90bb2df92b9f4e23b0308e99d977bd925fb41028d2efaf6f2"
        ),
        .binaryTarget(

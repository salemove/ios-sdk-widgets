...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "GliaCoreSDK",
            url: "https://github.com/salemove/ios-bundle/releases/download/2.6.1/GliaCoreSDK.xcframework.zip",
            checksum: "88df4e579228ead92945006457333b12e5d72ca5bf23d06d9b70adfb746beb31"
        ),
        .binaryTarget(

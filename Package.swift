...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "GliaCoreSDK",
            url: "https://github.com/salemove/ios-bundle/releases/download/2.1.3/GliaCoreSDK.xcframework.zip",
            checksum: "47b9de61ce2bee0ba4fb16b9dedad23f33946acb32a6ec3c8d7057886cd6f4bc"
        ),
        .binaryTarget(

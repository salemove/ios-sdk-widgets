...
extension UIView {
    ...
    func makeGradientBackground(colors: [CGColor], cornerRadius: CGFloat?) -> CAGradientLayer {
    ...
    /// Adds a CAGradientLayer to an existing view, taking colors as a parameter.
    /// If the view's base layer is already a gradient, it won't redraw it.
    func makeGradientBackground(colors: [CGColor]) -> CAGradientLayer {
        let l: CAGradientLayer

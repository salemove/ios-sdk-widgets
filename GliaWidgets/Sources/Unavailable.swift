...
extension ChatStyle {
    ...
    @available(*, unavailable, message: "Deprecated, use ``ChatStyle.operatorMessageStyle`` instead.")
    public var operatorMessage: OperatorChatMessageStyle {
        unavailable()
    }

    /// Unavailable. Style of the system message
    @available(*, unavailable, message: "Deprecated, use ``ChatStyle.systemMessageStyle`` instead.")
    public var systemMessage: SystemMessageStyle {
        unavailable()
    }

    /// Unavailable. Style of the message sent by the visitor.
    @available(*, unavailable, message: "Deprecated, use ``ChatStyle.visitorMessageStyle`` instead.")
    ...
    @available(*, unavailable, message: "Deprecated, use ``ChatStyle.choiceCardStyle`` instead.")
    ...
    @available(*, unavailable, message: "Deprecated, use designated initializer instead.")
...
/// Unavailable. Style of the choice card sent to the visitor by the AI engine.
@available(*, unavailable, message: "Deprecated, use ``Theme.ChoiceCardStyle`` instead.")

...
/// Style of the unread message indicator. It appears in the chat view when a new message is 
/// received and the user has scrolled up and is not seeing the end of the chat. It consists of
/// the operator's image in a frame and a badge indicating the number of unread messages.
...
public struct UnreadMessageIndicatorStyle {
    ...
    ///   - imageBackgroundColor: Background color of the operator's image. Visible when the operator's image contains 
    ///     transparent parts.
    ///   - imageBackgroundColor: Background color of the operator's image. Visible when the operator's image contains
    ///     transparent parts.

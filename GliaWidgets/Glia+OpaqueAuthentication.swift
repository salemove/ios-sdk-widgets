...
extension Glia {
    public func authentication() throws -> Authentication {
        let auth = try environment.coreSdk.authentication()

        // Reset navigation and UI back initial.
        // This is not sufficient for now. wip.

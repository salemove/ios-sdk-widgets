...
final class MediaPickerLayoutTests: SnapshotTestCase {
    func test_mediaPicker() {
        ...
        mediaPickerView.view.assertSnapshot(as: .image, in: .portrait)
        mediaPickerView.view.assertSnapshot(as: .image, in: .landscape)
    }
}
